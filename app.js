(() => {
  ...
  const viewLabels = { overview: "Рабочий обзор", ideal: "Идеальная сетка", growth: "Рост и идеи", builder: "Идеи и обложки", postbuilder: "Сборщик каруселей", current: "Текущая сетка", library: "Медиатека", planner: "План недели" };
